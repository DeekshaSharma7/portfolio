...
// Project.js
import React from 'react';
import '../styles/Projects.css'; // Ensure you have the necessary CSS styles
...
const projects = [
   ...
   },
 {
  ...
  {
    title: "Landing Page",
    description: "A Travelling Landing Page utilizing HTML, CSS, and JavaScript.",
    image: pic2,
    demoLink: "https://01landing-page01.netlify.app/",
    githubLink: "https://github.com/DeekshaSharma7/Landing_Page",
    date: "15/07/2023",
  },
  // ... (other projects)
...
const Project = () => {
  return (
    <section className="project" id="projects">
      <h2 className="h2-contact">PROJECTS</h2>
        ...
        {projects.map((project, index) => (
          <div className="timeline-item" key={index}>
            <div className="timeline-content">
              ...
              <h4>{project.title}</h4>
              <p>{project.description}</p>
              <div className="tech-used">{/* Add tech stack if needed */}</div>
              <a
                href={project.demoLink}
                target="_blank"
                rel="noopener noreferrer"
